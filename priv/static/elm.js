...
var $author$project$Main$Model = F3(
	function (res, key, url) {
		return {key: key, res: res, url: url};
	});
...
var $author$project$Graphql$Post = F3(
	function (content, likes, title) {
		return {content: content, likes: likes, title: title};
	});
...
var $author$project$WithElm$Object$Post$content = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'content', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$WithElm$Object$Post$likes = A4(
...
var $author$project$WithElm$Object$Post$title = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'title', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Graphql$postSelection = A4($dillonkearns$elm_graphql$Graphql$SelectionSet$map3, $author$project$Graphql$Post, $author$project$WithElm$Object$Post$content, $author$project$WithElm$Object$Post$likes, $author$project$WithElm$Object$Post$title);
...
var $author$project$WithElm$Query$posts = function (object____) {
	return A4(
...
var $author$project$Graphql$query = $author$project$WithElm$Query$posts($author$project$Graphql$postSelection);
...
var $dillonkearns$elm_graphql$Graphql$Document$Field$compositeToField = function (_v0) {
	var record = _v0.a;
	var children = _v0.b;
	return A3($dillonkearns$elm_graphql$Graphql$RawField$Composite, record.name, record.args, children);
};
var $dillonkearns$elm_graphql$Graphql$Document$Field$leafToField = function (_v0) {
	var record = _v0.a;
	var _arguments = _v0.b;
	return A2($dillonkearns$elm_graphql$Graphql$RawField$Leaf, record, _arguments);
};
...
var $dillonkearns$elm_graphql$Graphql$Document$Field$mergeFields = function (rawFields) {
	return A3(
		...
		F2(
			function (field, _v0) {
				var leaves = _v0.leaves;
				var composites = _v0.composites;
				if (field.$ === 'Composite') {
					var fieldName = field.a;
					var args = field.b;
					var children = field.c;
							...
							function (maybeChildrenSoFar) {
								return $elm$core$Maybe$Just(
									A2(
										...
										$elm$core$Basics$append(children),
										A2(
											$elm$core$Maybe$withDefault,
											_Utils_Tuple2(
												{args: args, name: fieldName},
												_List_Nil),
											maybeChildrenSoFar)));
							},
							composites),
		...
		{composites: $elm$core$Dict$empty, leaves: $elm$core$Dict$empty},
		rawFields);
};
...
var $dillonkearns$elm_graphql$Graphql$Document$Field$mergedFields = function (children) {
	var mergeThing = $dillonkearns$elm_graphql$Graphql$Document$Field$mergeFields(children);
	return _Utils_ap(
		A2(
			$elm$core$List$map,
			$dillonkearns$elm_graphql$Graphql$Document$Field$leafToField,
			$elm$core$Dict$values(mergeThing.leaves)),
		A2(
			$elm$core$List$map,
			$dillonkearns$elm_graphql$Graphql$Document$Field$compositeToField,
			$elm$core$Dict$values(mergeThing.composites)));
};
...
var $author$project$Main$makeRequest = A2(
	...
	A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, 'http://localhost:4000/api/graphql', $author$project$Graphql$query));
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$Model, $krisajenkins$remotedata$RemoteData$NotAsked, key, url),
							...
							_List_fromArray(
								[
									...
									A2(
											...
											return A2(
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$text(' - '),
														$elm$html$Html$text(l.content),
														$elm$html$Html$text('. Amount of likes: '),
														$elm$html$Html$text(
														function () {
															var _v1 = l.likes;
															if (_v1.$ === 'Just') {
																var amount_likes = _v1.a;
																return $elm$core$Debug$toString(amount_likes);
															} else {
																return 'No likes yet';
															}
														}())
										...
										a)),
									$elm$html$Html$text('The link is: '),
									A2(
									$elm$html$Html$b,
									_List_Nil,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$author$project$Main$viewLink('/donger'),
											$author$project$Main$viewLink('/very/nice')
										]))
								]));
				}
			}()
