...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($krisajenkins$remotedata$RemoteData$NotAsked, $author$project$Main$makeRequest);
};
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$text(
									$elm$core$Debug$toString(l.content)),
									$elm$html$Html$text(
									$elm$core$Debug$toString(l.likes))
								]));
					},
					a));
	}
